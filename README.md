...
### piazza style "chat"/ "thread" where members of the groups can talk to eachother:
...
There were some implementations that the backend members made that we were not able (we were struggling :() to implement on the frontend side :( 
